...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "Sahil Ansari, Full Stack Developer, Laravel Developer, PHP Developer, Web Developer Bengaluru, eCommerce Developer, CRM Developer, Portfolio" },
      { name: "author", content: "Sahil Ansari" },
